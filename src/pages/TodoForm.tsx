...
//           `http://localhost:5000/api/todos/${id || cloneId}`,
//           { headers: { Authorization: `Bearer ${token}` } }
//         );
//         const data = await res.json();
//         setTitle(data.title);
...
//   return (
//     <div className="min-h-screen bg-gradient-to-tr from-blue-100 to-purple-100 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-white flex flex-col">
//       <Header />
//       <main className="flex justify-center items-start p-6">
//         <div className="w-full max-w-3xl bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-700 p-8 space-y-8">
//           <h1 className="text-3xl md:text-4xl font-extrabold text-center text-blue-600 dark:text-blue-400 mb-6">
...
//                 className="w-full p-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
//               />
...
//                 className="w-full p-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none transition-all"
//                 rows={4}
//               />
//               {errors.description && <p className="text-red-500 text-sm mt-1">{errors.description}</p>}
//             </div>
...
//                 <h2 className="text-lg font-semibold text-gray-700 dark:text-gray-200">List (max {Maxlist})</h2>
//                 <button
//                   type="button"
//                   onClick={handleAddChild}
//                   disabled={list.length >= Maxlist}
//                   className="flex items-center gap-1 px-4 py-2 rounded-xl bg-green-600 hover:bg-green-700 text-white font-medium disabled:opacity-50 transition-all"
//                 >
//                   + Add
//                 </button>
//               </div>
...
//                   <div
//                     key={id}
//                     className="p-4 border border-gray-300 dark:border-gray-600 rounded-2xl bg-gray-50 dark:bg-gray-900 shadow-sm transition-all hover:shadow-md"
//                   >
//                     <div className="flex justify-between items-center mb-3">
//                       <h3 className="font-semibold text-gray-700 dark:text-gray-200">Item {id + 1}</h3>
//                       <button
//                         type="button"
//                         onClick={() => handleRemoveChild(id)}
//                         disabled={list.length === 1}
//                         className="px-3 py-1 rounded-lg bg-red-500 hover:bg-red-600 text-white disabled:opacity-50 transition-all"
//                       >
//                         Remove
//                       </button>
//                     </div>
...
//                           value={child.name}
//                           onChange={e => handleChildChange(id, "name", e.target.value)}
//                           className="w-full p-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
//                         />
//                         {errors.children?.[id]?.name && <p className="text-red-500 text-sm mt-1">{errors.children[id].name}</p>}
//                       </div>
...
//                           className="w-full p-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
//                         />
//                         {errors.children?.[id]?.email && <p className="text-red-500 text-sm mt-1">{errors.children[id].email}</p>}
//                       </div>
...
//                           className="w-full p-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
//                         />
//                         {errors.children?.[id]?.phone && <p className="text-red-500 text-sm mt-1">{errors.children[id].phone}</p>}
//                       </div>
//                     </div>
//                   </div>
//                 ))}
...
//                 type="button"
//                 onClick={() => navigate("/dashboard")}
//                 className="px-6 py-2 rounded-xl border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 font-medium transition-all"
//               >
//                 Cancel
//               </button>
//               <button
//                 type="submit"
//                 className="px-6 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold transition-all shadow-md hover:shadow-lg"
//               >
//                 {id ? "Update Todo" : "Save Todo"}
//               </button>
//             </div>
